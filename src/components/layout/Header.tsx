  ...
  return (
    <header
      className={cn(
        ...
        isScrolled
          ? 'border-b border-neutral-800 bg-surface-background/95 shadow-lg backdrop-blur-xl'
          : 'bg-transparent'
      )}
      ...
      >
        <div className="flex h-16 items-center justify-between lg:h-20">
          ...
          <div className="flex-shrink-0">
            <Link
              href="/"
              className="flex items-center space-x-3 rounded-lg text-text-primary transition-colors hover:text-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 focus:ring-offset-surface-background"
              ...
              return (
                <Link
                  ...
                  className={cn(
                    ...
                    isActive &&
                      'border border-primary-500/20 bg-primary-500/10 text-primary-400',
                    !isActive &&
                      !isDisabled &&
        ...
        >
          <div className="space-y-2 border-t border-neutral-800 pb-2 pt-4">
            {navigationItems.map((item) => {
              const isActive = pathname === item.href;
              const isDisabled = item.disabled;
