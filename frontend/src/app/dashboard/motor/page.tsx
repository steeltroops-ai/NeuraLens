      ...
      <div className="bg-white rounded-xl border border-zinc-200 p-6">
        <div className="flex items-start gap-4">
          <div className="p-3 rounded-lg bg-violet-50">
            <Hand className="h-6 w-6 text-violet-600" strokeWidth={1.5} />
          </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
          <div className="flex items-center gap-2 p-3 bg-zinc-50 rounded-lg">
            ...
            <div>
              <div className="text-[13px] font-medium text-zinc-900">93.5%</div>
          ...
          <div className="flex items-center gap-2 p-3 bg-zinc-50 rounded-lg">
            ...
            <div>
              <div className="text-[13px] font-medium text-zinc-900">15s</div>
          ...
          <div className="flex items-center gap-2 p-3 bg-zinc-50 rounded-lg">
            ...
            <div>
              <div className="text-[13px] font-medium text-zinc-900">UPDRS</div>
