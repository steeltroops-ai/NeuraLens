...
import { Upload, Sparkles, AlertTriangle, CheckCircle2, Loader2, Camera, Info, Activity, TrendingUp } from 'lucide-react';
...
export function DermatologyAssessment() {
    ...
    const handleAnalyze = async () => {
        ...
        setResult({
            ...
            confidence: 92.3,
            riskLevel: 'benign',
            recommendation: 'No immediate action required. Continue routine monitoring. Schedule follow-up in 6 months.',
            features: [
                'Symmetrical borders',
            ...
            <div className="rounded-xl border border-zinc-200 bg-white p-6">
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        <h1 className="text-[20px] font-semibold text-zinc-900">SkinSense AI</h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-4">
                    <div className="flex items-center gap-2 p-3 bg-zinc-50 rounded-lg">
                        ...
                        <span className="text-[13px] text-zinc-700">Image Analysis</span>
                    </div>
                    <div className="flex items-center gap-2 p-3 bg-zinc-50 rounded-lg">
                        <Activity className="h-4 w-4 text-zinc-500" />
                        <span className="text-[13px] text-zinc-700">Lesion Detection</span>
                    </div>
                    <div className="flex items-center gap-2 p-3 bg-zinc-50 rounded-lg">
                        <TrendingUp className="h-4 w-4 text-zinc-500" />
                        <span className="text-[13px] text-zinc-700">Risk Assessment</span>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    <div className="bg-white border border-zinc-200 rounded-xl p-6 shadow-sm">
                        ...
                        {isAnalyzing && (
                            <div className="text-center py-12">
                                <Loader2 size={48} className="text-purple-500 mx-auto mb-4 animate-spin" />
                                <p className="text-sm text-zinc-900 mb-2">Analyzing skin lesion...</p>
                                <p className="text-xs text-zinc-500">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4">
                                    <div className="flex items-start justify-between mb-3">
                                        <div>
                                            <h3 className="text-base font-semibold text-zinc-900 mb-1">{result.diagnosis}</h3>
                                            <p className="text-xs text-zinc-500">Primary Classification</p>
                                        </div>
                                ...
                                {/* Detected Features */}
                                <div className="bg-zinc-50 border border-zinc-200 rounded-lg p-4">
                                    <h4 className="text-sm font-medium text-zinc-900 mb-3">Detected Features</h4>
                                ...
                                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                    <h4 className="text-sm font-medium text-blue-700 mb-2">Clinical Recommendation</h4>
                                    <p className="text-xs text-blue-600">{result.recommendation}</p>
                                </div>
                                ...
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <p className="text-xs text-yellow-700">
                                            AI analysis is for screening purposes only. Always consult a dermatologist for definitive diagnosis and treatment.
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    {result && (
                        <div className="bg-white border border-zinc-200 rounded-xl p-6 shadow-sm">
                            <h3 className="text-sm font-medium text-zinc-900 mb-3">ABCDE Criteria Assessment</h3>
                            <div className="space-y-2">
                                {[
                                    ...
                                    <div key={criteria.letter} className="flex items-center justify-between bg-zinc-50 rounded-lg p-2 border border-zinc-100">
                                        <div className="flex items-center gap-2">
                                            <span className="text-xs font-bold text-purple-600 w-6">{criteria.letter}</span>
                                            <span className="text-xs text-zinc-600">{criteria.label}</span>
                                        </div>
                                        <span className={`text-xs font-medium ${criteria.status === 'pass' ? 'text-green-600' : 'text-zinc-500'
                                            }`}>
