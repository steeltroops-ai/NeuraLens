            ...
            <div className="container mx-auto px-4">
              ...
              >
                ...
                <p className="text-xl leading-relaxed text-slate-600">
                  Pioneering the future of neurological health assessment through advanced AI technology
                </p>
              </motion.div>
            </div>
          </section>
          ...
          <section className="bg-gray-50 py-20">
            <div className="container mx-auto px-4">
              ...
              >
                ...
                <p className="text-xl leading-relaxed text-slate-600">
                  Our platform combines speech analysis, retinal imaging, motor assessment, 
                  and cognitive evaluation using state-of-the-art machine learning models 
                  to provide comprehensive neurological health insights.
                </p>
              </motion.div>
            </div>
          </section>
