...
// Initialize mermaid with improved styling
mermaid.initialize({
    startOnLoad: false,
    theme: 'dark',
    securityLevel: 'loose',
...
// Mermaid Component with better styling
const MermaidDiagram = ({ chart, id }: { chart: string; id: string }) => {
    ...
    return <div ref={ref} className="overflow-x-auto p-6 flex justify-center" />;
};
            ...
            <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
                ...
                >
                    ...
                    <p className="mx-auto max-w-2xl text-[14px] sm:text-[15px] leading-relaxed text-zinc-400 mb-8">
                        Technical overview of MediLens' architecture, ML pipelines, and infrastructure.
                        Built for developers and technical stakeholders.
                    </p>
...
function PlatformOverviewSection() {
    const modules = [
        ...
        },
        {
            ...
            diagnoses: ['Diabetic Foot Ulcers', 'Wound Classification', 'Infection Risk'],
            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="flex items-center gap-2 mb-3 sm:mb-4">
                        ...
                        <span className="text-[10px] sm:text-[11px] font-medium text-zinc-400 uppercase tracking-widest">Platform Overview</span>
                    </div>
                    ...
                    <p className="max-w-2xl text-[14px] sm:text-[15px] text-zinc-400 leading-relaxed">
                        Each module is built with specialty-specific AI models, trained on validated medical datasets,
                        and designed for clinical-grade accuracy. From ophthalmology to multi-modal fusion.
                    </p>
                </motion.div>
                ...
                >
                    {modules.map((module, index) => (
                        ...
                        >
                            ...
                            {/* Icon */}
                            <div className={`flex h-12 w-12 items-center justify-center rounded-lg ${module.bg} mb-4`}>
                                <module.icon className={`h-6 w-6 ${module.color}`} strokeWidth={1.5} />
                            </div>

                            {/* Content */}
                            <h3 className="text-[15px] font-medium text-white mb-1">{module.name}</h3>
                            <p className="text-[11px] font-mono text-zinc-500 uppercase tracking-wider mb-4">{module.specialty}</p>

                            {/* Diagnoses */}
                            <div className="mb-4">
                                <p className="text-[10px] font-medium text-zinc-600 uppercase tracking-wider mb-2">Diagnoses</p>
                            ...
                            <div className="pt-4 border-t border-zinc-800/50 space-y-2">
                                <div>
                                    <p className="text-[10px] font-medium text-zinc-600 uppercase tracking-wider mb-1">Models</p>
                                    <p className="text-[11px] text-zinc-500 font-mono">{module.models}</p>
                                </div>
                                <div>
                                    <p className="text-[10px] font-medium text-zinc-600 uppercase tracking-wider mb-1">Datasets</p>
                                    <p className="text-[11px] text-zinc-500 font-mono">{module.datasets}</p>
                                </div>
                            </div>
                        </motion.div>
                    ))}
...
function ArchitectureSection() {
    ...
    return (
        <section id="architecture" className="bg-black py-16 sm:py-20 lg:py-24 border-t border-zinc-900">
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                    <div className="flex items-center gap-2 mb-3 sm:mb-4">
                        ...
                        <span className="text-[10px] sm:text-[11px] font-medium text-zinc-400 uppercase tracking-widest">System Architecture</span>
                    </div>
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-white mb-3 sm:mb-4 tracking-tight">
                        Modern, Scalable Architecture
                    </h2>
                    <p className="max-w-2xl text-[14px] sm:text-[15px] text-zinc-400 leading-relaxed">
                        MediLens adopts a modular, microservices-based architecture that separates client-side
                        presentation from high-performance ML inference services, ensuring scalability and maintainability.
                    </p>
                </motion.div>
                ...
                <div className="bg-zinc-900/30 border border-zinc-800 rounded-2xl overflow-hidden">
                    ...
                    <div className="flex border-b border-zinc-800">
                        <button
                            ...
                            className={`flex-1 px-4 sm:px-6 py-3 sm:py-4 text-[13px] sm:text-[14px] font-medium transition-all duration-200 ${activeTab === 'system'
                        ...
                        <button
                            ...
                            className={`flex-1 px-4 sm:px-6 py-3 sm:py-4 text-[13px] sm:text-[14px] font-medium transition-all duration-200 ${activeTab === 'pipeline'
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mt-8">
                                    <div className="p-4 sm:p-5 rounded-lg bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 transition-colors">
                                        ...
                                        <p className="text-[12px] text-zinc-400 leading-relaxed">
                                            Next.js 15 App Router with React Server Components for optimal First Contentful Paint (FCP)
                                            and SEO. Clerk handles authentication with JWT tokens.
                                        </p>
                                    </div>
                                    <div className="p-4 sm:p-5 rounded-lg bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 transition-colors">
                                        ...
                                        <p className="text-[12px] text-zinc-400 leading-relaxed">
                                            Route Handlers provide rate limiting, Zod schema validation, and authentication guards.
                                    ...
                                    <div className="p-4 sm:p-5 rounded-lg bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 transition-colors">
                                        ...
                                        <p className="text-[12px] text-zinc-400 leading-relaxed">
                                            Python-based microservices running PyTorch/TensorFlow models on GPU instances.
            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="flex items-center gap-2 mb-3 sm:mb-4">
                        ...
                        <span className="text-[10px] sm:text-[11px] font-medium text-zinc-400 uppercase tracking-widest">Technology Stack</span>
                    </div>
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-white mb-3 sm:mb-4 tracking-tight">
                        Built on Industry Standards
                    </h2>
                    <p className="max-w-2xl text-[14px] sm:text-[15px] text-zinc-400 leading-relaxed">
                        Leveraging battle-tested, open-source technologies for reliability, performance, and scalability.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
                    {stack.map((item, i) => (
                        ...
                        >
                            ...
                            <h3 className="text-[15px] font-semibold text-white mb-4">{item.domain}</h3>
                            <ul className="space-y-2">
                                {item.tools.map(tool => (
                                    <li key={tool} className="text-[12px] text-zinc-400 flex items-start gap-2">
                ...
                >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {[
                            ...
                            { metric: 'ML Inference', value: '200-800ms', desc: 'Per modality' },
                            { metric: 'Uptime', value: '99.9%', desc: 'SLA guarantee' },
                            { metric: 'Throughput', value: '100+', desc: 'Concurrent requests' },
                        ].map((item, i) => (
                            <div key={i} className="text-center">
                                <div className="text-2xl sm:text-3xl font-semibold text-white mb-1">{item.value}</div>
                                <div className="text-[12px] font-medium text-zinc-400 mb-1">{item.metric}</div>
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="flex items-center justify-center gap-2 mb-3">
                        ...
                        <span className="text-[10px] font-medium text-zinc-400 uppercase tracking-widest">Development Roadmap</span>
                    </div>
                    ...
                    <p className="max-w-2xl mx-auto text-[14px] text-zinc-400 leading-relaxed">
                        From foundational infrastructure to full clinical ecosystem integration.
                    </p>
                </motion.div>

                {/* Horizontal Zigzag Timeline - Desktop */}
                <div className="hidden lg:block relative">
                    {/* Horizontal Line */}
                    <div className="absolute top-1/2 left-0 right-0 h-[2px] bg-gradient-to-r from-green-500 via-blue-500 to-zinc-700 -translate-y-1/2" />

                    <div className="grid grid-cols-4 gap-8 relative" style={{ minHeight: '600px' }}>
                        {phases.map((phase, i) => (
                            <motion.div
                                key={phase.number}
                                ...
                                viewport={{ once: true }}
                                className={`relative flex flex-col ${phase.position === 'top'
                            ...
                            >
                                ...
                                <div className="relative w-full">
                                    <div className="relative p-5 rounded-xl border border-zinc-800 bg-zinc-900/50 hover:bg-zinc-900/70 hover:border-zinc-700 transition-all duration-300">
                                        ...
                                        <div className="absolute -top-3 -left-3 w-9 h-9 rounded-lg bg-gradient-to-br from-zinc-800 to-zinc-900 border border-zinc-700 flex items-center justify-center">
                                            <span className="text-[13px] font-bold text-zinc-400 font-mono">{phase.number}</span>
                                        </div>

                                        {/* Header */}
                                        <div className="flex items-start justify-between mb-3 pt-1">
                                            <div>
                                                <h3 className="text-[15px] font-semibold text-white mb-1">{phase.title}</h3>
                                                <p className="text-[11px] text-zinc-500 font-mono">{phase.timeline}</p>
                                            </div>
                                            <phase.icon className="h-4 w-4 text-zinc-500 flex-shrink-0 ml-2" strokeWidth={1.5} />
                                        </div>
                                        ...
                                        <ul className="space-y-2">
                                            {phase.items.map((item, idx) => (
                                                <li key={idx} className="text-[12px] text-zinc-400 flex items-start gap-2 leading-relaxed">
                                                    <ChevronRight className="h-3.5 w-3.5 text-zinc-600 flex-shrink-0 mt-0.5" strokeWidth={2} />
                                                    <span>{item}</span>
                                                </li>
                                            ))}
                                        </ul>
                                    ...
                                    <div
                                        className={`absolute left-1/2 -translate-x-1/2 w-[2px] bg-zinc-700 ${phase.position === 'top'
                                                ? 'top-full h-16'
                                                : 'bottom-full h-16'
                                            }`}
                                    />
                                ...
                                <div
                                    className={`absolute left-1/2 -translate-x-1/2 ${phase.position === 'top' ? 'bottom-0' : 'top-0'
                                        }`}
                                >
                                    <div
                                        className={`w-10 h-10 rounded-full border-4 border-black flex items-center justify-center ${phase.status === 'completed'
                                                ? 'bg-green-500'
                                                : phase.status === 'active'
                                                    ? 'bg-blue-500'
                                                    : 'bg-zinc-700'
    ...
    const features = [
        {
            ...
            description: 'Full healthcare data protection with end-to-end encryption, audit logging, and access controls.',
            color: 'text-blue-400',
            bg: 'bg-blue-900/10',
        },
        {
            ...
            description: 'AES-256 encryption at rest, TLS 1.3 in transit. All medical data stored in encrypted S3 buckets.',
        ...
        },
        {
            ...
            description: 'Granular RBAC with JWT authentication. Separate permissions for patients, providers, and admins.',
            color: 'text-violet-400',
            bg: 'bg-violet-900/10',
        },
        {
            icon: FileCode,
            title: 'Audit Trails',
            description: 'Complete audit logging of all diagnostic actions, data access, and system events for compliance.',
            color: 'text-amber-400',
            bg: 'bg-amber-900/10',
        },
    ];
            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="flex items-center justify-center gap-2 mb-3 sm:mb-4">
                        ...
                        <span className="text-[10px] sm:text-[11px] font-medium text-zinc-400 uppercase tracking-widest">Security & Compliance</span>
                    </div>
                    <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-white mb-3 sm:mb-4 tracking-tight">
                        Enterprise-Grade Security
                    </h2>
                    <p className="mx-auto max-w-2xl text-[14px] sm:text-[15px] text-zinc-400 leading-relaxed">
                        Built with healthcare compliance at the core. Every layer of the stack implements
                        industry-standard security practices and regulatory requirements.
                    </p>
                </motion.div>
            ...
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
                ...
                >
                    ...
                    <p className="text-[14px] sm:text-[15px] text-zinc-400 mb-8 sm:mb-10 max-w-2xl mx-auto">
                        Explore our AI-powered diagnostic platform or get in touch to discuss
