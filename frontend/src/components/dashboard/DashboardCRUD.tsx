    ...
    <div className='space-y-6'>
      ...
      <div className='rounded-xl border border-slate-200 bg-white p-6 shadow-sm'>
        <div className='mb-6 flex items-center justify-between'>
          <div>
            <h1 className='text-3xl font-bold text-slate-900'>NeuraLens Dashboard</h1>
            <p className='text-slate-600'>Comprehensive neurological assessment platform</p>
          </div>
  ...
  return (
    <div className='flex h-screen bg-slate-50'>
      ...
      <div className='w-64 border-r border-slate-200 bg-white'>
        <div className='p-6'>
          <h2 className='text-lg font-semibold text-slate-900'>NeuraLens</h2>
          ...
          {navigationItems.map(item => {
            ...
            return (
              <button
                ...
                className={`mb-2 flex w-full items-center space-x-3 rounded-lg px-3 py-2 text-left text-sm font-medium transition-colors ${
