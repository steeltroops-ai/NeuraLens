...
export const ResultsDashboard: React.FC = () => {
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8">
      ...
      {/* NRI Score Display */}
      <NRIScoreDisplay
        score={results.nriResult.nriScore}
        confidence={results.nriResult.confidence}
        riskLevel={results.nriResult.riskCategory}
      />
      ...
      <div className="min-h-[400px]">
        {activeTab === 'overview' && (
          <div className="space-y-8">
            ...
            {/* Modality Breakdown */}
            <ModalityBreakdown
              speechScore={results.modalityResults.speech?.riskScore || 0}
              retinalScore={results.modalityResults.retinal?.riskScore || 0}
              motorScore={results.modalityResults.motor?.overallRisk || 0}
              cognitiveScore={results.modalityResults.risk?.overallRisk || 0}
            />
          </div>
        )}
