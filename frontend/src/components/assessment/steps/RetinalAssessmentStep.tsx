      ...
      <div className='container mx-auto px-6'>
        <div className='mx-auto max-w-4xl space-y-12'>
          ...
          <div className='animate-fade-in space-y-6 text-center'>
            ...
            <h1 className='text-4xl font-bold tracking-tight text-text-primary'>Eye Health Scan</h1>
              ...
              {selectedFile ? (
                <div className='space-y-6'>
                  ...
                  <div className='space-y-3'>
                    ...
                    <p className='text-lg text-text-secondary'>{selectedFile.name}</p>
                ...
                <div className='space-y-8'>
                  ...
                  <div className='space-y-4'>
                    ...
                    <p className='text-lg leading-relaxed text-text-secondary'>
                      Drag and drop your retinal fundus image here, or click to browse
                    </p>
                    <input
                      type='file'
                      accept='image/*'
            ...
            <div className='grid grid-cols-1 gap-6 md:grid-cols-2'>
              <div className='flex items-start space-x-3'>
                <div className='flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-apple bg-neural-100'>
                  <svg className='h-4 w-4 text-neural-600' fill='currentColor' viewBox='0 0 20 20'>
                    <path
                      fillRule='evenodd'
                ...
                <div>
                  <h5 className='font-medium text-text-primary'>High Quality</h5>
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  <h5 className='font-medium text-text-primary'>File Formats</h5>
                  <p className='text-sm text-text-secondary'>JPEG, PNG, TIFF supported</p>
                </div>
              </div>
              ...
              <div className='flex items-start space-x-3'>
                ...
                <div>
                  ...
                  <p className='text-sm text-text-secondary'>Maximum 10 MB per image</p>
                </div>
              </div>
            </div>
          </div>
