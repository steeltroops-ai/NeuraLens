      ...
      <div className="container mx-auto px-6">
        <div className="mx-auto max-w-4xl space-y-12">
          ...
          <div className="animate-fade-in space-y-6 text-center">
            <div className="rounded-apple-xl from-medical-500 to-medical-600 shadow-medical mx-auto flex h-20 w-20 items-center justify-center bg-gradient-to-br">
              <svg
            ...
            <p className="mx-auto max-w-2xl text-xl leading-relaxed text-text-secondary">
              Record a 30-second voice sample to check for early signs of
          ...
          <div className="card-apple animate-slide-up p-12">
            <div className="space-y-8 text-center">
              <div className="from-medical-50 to-medical-100 mx-auto flex h-40 w-40 items-center justify-center rounded-full bg-gradient-to-br shadow-inner">
                {isRecording ? (
                  <div className="from-error-400 to-error-500 h-20 w-20 animate-pulse rounded-full bg-gradient-to-br shadow-lg" />
                ) : hasRecording ? (
                  <div className="from-success-400 to-success-500 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br shadow-lg">
                    <svg
                  ...
                  <div className="from-medical-400 to-medical-500 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br shadow-lg">
                    <svg
                      className="h-12 w-12 text-white"
                      fill="none"
                      stroke="currentColor"
          ...
          <div className="bg-medical-50 border-medical-100 rounded-apple-lg animate-scale-in border p-8">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="flex items-start space-x-3">
                <div className="bg-medical-100 rounded-apple flex h-8 w-8 flex-shrink-0 items-center justify-center">
                  <span className="text-medical-600 text-sm font-semibold">
                    1
                  </span>
                </div>
                <div>
