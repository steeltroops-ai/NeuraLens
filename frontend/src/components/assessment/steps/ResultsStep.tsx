...
export const ResultsStep: React.FC<ResultsStepProps> = ({ results, onRestart, onExit }) => {
    ...
    <div className='min-h-screen bg-gray-50 py-12'>
      <div className='container mx-auto px-6'>
        <div className='mx-auto max-w-6xl space-y-12'>
          ...
          <Card className='p-6'>
            <h3 className='mb-4 text-lg font-semibold text-slate-900'>Clinical Recommendations</h3>
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-4'>
            <Button onClick={handleDownloadReport} variant='secondary' size='lg' className='w-full'>
            ...
            <Button onClick={handleShareResults} variant='secondary' size='lg' className='w-full'>
              <svg className='mr-2 h-5 w-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                <path
                  strokeLinecap='round'
                  strokeLinejoin='round'
            ...
            <Button onClick={onExit} variant='secondary' size='lg' className='w-full'>
              <svg className='mr-2 h-5 w-5' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
                <path
                  strokeLinecap='round'
                  strokeLinejoin='round'
          ...
          <Card className='border-amber-500/20 bg-amber-500/5 p-6'>
            <div className='flex items-start space-x-3'>
              ...
              <div>
                <h3 className='mb-2 font-semibold text-amber-400'>Important Medical Disclaimer</h3>
                <p className='text-sm leading-relaxed text-text-secondary'>
                  This health check is a screening tool and not a medical diagnosis. Results should
