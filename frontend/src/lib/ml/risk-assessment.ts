...
export class RiskAssessmentCalculator {
  ...
  private calculateDemographicRisk(demographics: DemographicData): number {
    ...
    const ethnicityMultiplier =
      this.ethnicityRisks[ethnicityKey as keyof typeof this.ethnicityRisks] || 1.0;
  ...
  private calculateOverallRisk(categoryRisks: {
    ...
    const weights = {
      ...
      medical: 0.2, // Medical conditions important
      family: 0.2, // Genetic factors significant
      lifestyle: 0.15, // Modifiable factors
      cognitive: 0.2, // Current symptoms important
    };
