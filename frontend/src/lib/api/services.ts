...
export const SpeechAnalysisService = {
  ...
  async analyze(
    ...
    if (request.quality_threshold) {
      formData.append(
        "quality_threshold",
        request.quality_threshold.toString(),
      );
    }
  ...
  async getResults(
    ...
    return apiClient.get<SpeechAnalysisResponse>(
      `/speech/results/${sessionId}`,
    );
  },
  ...
  async analyzeEnhanced(
    ...
    return apiClient.postFormData<EnhancedSpeechAnalysisResponse>(
      "/speech/analyze/enhanced",
      formData,
    );
  },
...
export const RetinalAnalysisService = {
  ...
  async getResults(
    ...
    return apiClient.get<RetinalAnalysisResponse>(
      `/retinal/results/${sessionId}`,
    );
  },
...
export const MotorAssessmentService = {
  ...
  async getResults(
    ...
    return apiClient.get<MotorAssessmentResponse>(
      `/motor/results/${sessionId}`,
    );
  },
...
export const CognitiveAssessmentService = {
  ...
  async getResults(
    ...
    return apiClient.get<CognitiveAssessmentResponse>(
      `/cognitive/results/${sessionId}`,
    );
  },
...
export const NRIFusionService = {
  ...
  ): Promise<ApiResponse<NRIFusionResponse>> {
   ...
   */
  async getBreakdown(sessionId: string): Promise<
    ApiResponse<{
 ...
 * Handles patient records and search
 */
