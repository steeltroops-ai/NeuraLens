...
import { mockAssessmentSession } from '../vitest.setup';
...
const MockRetinalAssessment = ({ onProcessingChange }: { onProcessingChange: (processing: boolean) => void }) => {
  return (
...
const MockMotorAssessment = ({ onProcessingChange }: { onProcessingChange: (processing: boolean) => void }) => {
  return (
...
const MockDashboard = () => {
  ...
  const renderActiveView = () => {
    switch (activeView) {
      case 'speech':
        return <MockSpeechAssessment onProcessingChange={setIsProcessing} />;
      case 'retinal':
        return <MockRetinalAssessment onProcessingChange={setIsProcessing} />;
      case 'motor':
        return <MockMotorAssessment onProcessingChange={setIsProcessing} />;
      case 'history':
      ...
      default:
        return (
          <div data-testid="dashboard-overview">
            ...
            <button onClick={() => handleNavigation('retinal')}>Retinal Analysis</button>
            <button onClick={() => handleNavigation('motor')}>Motor Assessment</button>
            <button onClick={() => handleNavigation('history')}>Assessment History</button>
          </div>
        );
    }
  };
  ...
  return (
    <div>
      <nav data-testid="dashboard-nav">
        ...
        <button onClick={() => handleNavigation('speech')}>Speech</button>
        <button onClick={() => handleNavigation('retinal')}>Retinal</button>
        <button onClick={() => handleNavigation('motor')}>Motor</button>
